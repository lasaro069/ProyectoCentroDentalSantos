	           ...
	           <div>
	     			<form class="form-sign" method="get" action="Controlador">
			        	...
			        	<div class="form-group">
			         		...
			         		<input type="text" name="txtapellido" class="form-control" value="${pacienteSeleccionado.getNombre_paciente()}">
			        	</div>
			        	<div class="form-group">
			         		<label>Celular:</label>
			         		<input type="text" name="txtcelular" class="form-control" value="${pacienteSeleccionado.getDireccion_paciente()}">
			        	</div>
			        	<div class="form-group">
			         		<label>Email:</label>
		...
		<table class="table">
	        ...
	        <tbody>
				...
				<tr>
					...
					<td> 
		               <a class="btn btn-warning" href="Controlador?menu=Pacientes&accion=Cargar&id=<%=cliente.getCedula_cliente()%>">Editar</a>
		               <a class="btn btn-danger" href="Controlador?menu=Pacientes&accion=Eliminar&id=<%=cliente.getCedula_cliente()%>">Eliminar</a>
	            	</td>
	            </tr>
	            <%}%>
	        </tbody>
